...
def main():
    ...
    plt.plot(l4)
    plt.savefig("/home/cse/btech/cs1180349/scratch/train_acc.png")
    plot1 = plt.figure(2)
    plt.title("Train Loss vs epochs")
    plt.xlabel("Epoch")
    plt.ylabel("Train Loss")
    plt.plot(l3)
    plt.savefig("/home/cse/btech/cs1180349/scratch/train_loss.png")
    plot1 = plt.figure(3)
    plt.title("Test Accuracy vs epochs")
    plt.xlabel("Epoch")
    plt.ylabel("Test Accuracy")
    plt.plot(l2)
    plt.savefig("/home/cse/btech/cs1180349/scratch/test_acc.png")
    plot1 = plt.figure(3)
    plt.title("Test Loss vs epochs")
    plt.xlabel("Epoch")
    plt.ylabel("Test Loss")
    plt.plot(l1)
    plt.savefig("/home/cse/btech/cs1180349/scratch/test_loss.png")
    if save_model:
